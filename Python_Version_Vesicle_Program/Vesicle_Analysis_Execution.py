...
while button == True:
   ...
   if save_df_answer == True:
     ...
     Analysis_Stack.Image_stack_median = Analysis_Stack.Image_stack_median_circle_patch
   ...
   #If user wants to continue, replace original images with median images. Increase n by 1.
   if button == True:
     n+=1
